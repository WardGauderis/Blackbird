...
def create_datasets(path: str):
	create_dataset(path + "/train", 3000, "balanced")
	create_dataset(path + "/val", 300, "balanced")
	create_dataset(path + "/test", 300, "balanced")
 
	create_dataset(path + "/train", 3000, "independent")
	create_dataset(path + "/val", 300, "independent")
	create_dataset(path + "/test", 300, "independent")
